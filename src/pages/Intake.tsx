        ...
        <div className="mt-6 flex flex-wrap items-center gap-3">
          ...
          {EXAMPLES.map((ex) => (
            <button
              key={ex}
              onClick={() => setText(ex)}
              className="rounded-full border border-border bg-card px-4 py-2 text-sm text-foreground/80 shadow-sm transition-colors hover:border-primary/40 hover:bg-muted/50"
            >
              {ex}
            </button>
          ))}
